...
-- 1단계 : 기본키가 포함된 테이블 
drop table dept_tab cascade constraint; -- table 삭제 
...
insert into emp_tab values(1003, '유관순', 1500000, 3); -- error (마스터 테이블에 부서 번호 3번이 없음으로)
-- 참조무결성 제약조건 위배 
...
WHERE E.DEPTNO=D.DEPTNO AND D.LOC LIKE '대%';
