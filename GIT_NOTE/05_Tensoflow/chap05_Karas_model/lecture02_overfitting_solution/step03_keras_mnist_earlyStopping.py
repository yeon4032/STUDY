...
1.Dropout: 무작위 네트워크 삭제 -> 과적화 최소화
    - 적용 예 : 네트워크 많은 layer 적용, output 적용 안함
2.EarlyStopping
    - loss value에 변화가 없는 경우 특정 시점에서 학습 조기종료

lecture02 > step02_keras_mnist_dropout.py참고
"""
...
# 6. model training : train(60000) vs val(10000)  [추가]
