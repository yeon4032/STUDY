...
3. Flatten layer : 차원일치(2d:28,28 -> 1d:784)
"""
...
'''
input_shape = (28,28) # 2d image 

# flatten layer [추가]
model.add(Flatten(input_shape = input_shape))  # 입력 2d -> output 1d
...
# 6. model training : train(60000) vs val(10000)
