...
write.csv(CO2$Treatment== 'nonchilled', 'CO2_df1.csv')
help(write.csv)
# 단계2) Treatment 칼럼 값이 'chilled'인 경우만 'CO2_df2.csv' 파일로 저장 
write.csv(CO2$Treatment== 'chilled', 'CO2_df2.csv')
